<template>
  <div>
    <b-row>
      <b-colxx xxs="12">
        <piaf-breadcrumb heading="Settings"/>
        ...
        <b-card class="mb-4" :title="$t('forms.validation')">
          <b-form @submit.prevent="onValitadeFormSubmit">
              ...
              <b-colxx sm="6">
                <b-form-group :label="$t('forms.firstname')">
                  <b-form-input
                    ...
                    :state="!$v.validateForm.firstname.$invalid"
                  />
              ...
              <b-colxx sm="6">
                <b-form-group :label="$t('forms.lastname')">
                  <b-form-input
                    ...
                    :state="!$v.validateForm.lastname.$invalid"
                  />
              ...
              <b-colxx sm="6">
                <b-form-group :label="$t('forms.city')">
                  <b-form-input
                    ...
                    :state="!$v.validateForm.city.$invalid"
                  />
              ...
              <b-colxx sm="6">
                <b-form-group :label="$t('forms.state')">
                  <b-form-select
                    ...
                    plain
                    :state="!$v.validateForm.state.$invalid"
                  />
            ...
            <b-button
              ...
              variant="primary"
              class="mt-4"
              :disabled="$v.validateForm.$invalid"
